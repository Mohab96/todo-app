...
def export(request):
    ...
    # TODO: organize all the pending tasks that belong to the
    # current user and put them in a pdf and return it
...
def search(request):
    ...
    searchResult = Task.objects.filter(user__id=current_user_id, body__icontains=query)
